...
def split_log_file_path(log_path):
...
new_error_log_path = split_log_file_path(os.getcwd() + "/" + picture_test.error_log)
new_duplicates_log_path = split_log_file_path(os.getcwd() + "/" + picture_test.duplicates_log)
